...
class ViewController extends Controller
{
    ...
    public function get_product(Request $request)
    {
        ...
        if (!empty($price_column)) {
            $query->select('id', 'product_code', 'product_name', 'print_name', 'brand', 'category', 'sub_category', 'type', 'machine_part_no', DB::raw("$price_column as price"),`ppc`, 'product_image', 'new_arrival','special_price');
        }
